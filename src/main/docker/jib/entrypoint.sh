...
exec java ${JAVA_OPTS} -noverify -XX:+AlwaysPreTouch -cp /app/resources/:/app/classes/:/app/libs/* "es.imserso.sample.monoliticapp1.JhipsterMonoliticSampleApplicationApp"  "$@"
