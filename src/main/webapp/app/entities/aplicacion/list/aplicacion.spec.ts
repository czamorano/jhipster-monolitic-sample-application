...
import { sampleWithRequiredData } from '../aplicacion.test-samples';
...
describe('Aplicacion Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.aplicacions()[0]).toEqual(expect.objectContaining({ id: 7402 }));
  });

  describe('trackId', () => {
    it('should forward to aplicacionService', () => {
      const entity = { id: 7402 };
      vitest.spyOn(service, 'getAplicacionIdentifier');
      const id = comp.trackId(entity);
      expect(service.getAplicacionIdentifier).toHaveBeenCalledWith(entity);
