...
import { AplicacionDeleteDialog } from './aplicacion-delete-dialog';

describe('Aplicacion Management Delete Component', () => {
  let comp: AplicacionDeleteDialog;
  let fixture: ComponentFixture<AplicacionDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AplicacionDeleteDialog);
