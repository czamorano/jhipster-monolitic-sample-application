...
import { sampleWithRequiredData } from '../job-history-angulr.test-samples';
import { JobHistoryAngulrService } from '../service/job-history-angulr.service';

import { JobHistoryAngulr } from './job-history-angulr';

describe('JobHistoryAngulr Management Component', () => {
  let comp: JobHistoryAngulr;
  let fixture: ComponentFixture<JobHistoryAngulr>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(JobHistoryAngulr);
  ...
  describe('trackId', () => {
    it('should forward to jobHistoryService', () => {
      ...
      vitest.spyOn(service, 'getJobHistoryAngulrIdentifier');
      const id = comp.trackId(entity);
      expect(service.getJobHistoryAngulrIdentifier).toHaveBeenCalledWith(entity);
