...
import jobHistoryResolve from './job-history-angulr-routing-resolve.service';

describe('JobHistoryAngulr routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IJobHistoryAngulr returned by find', async () => {
      // GIVEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      // GIVEN
      vitest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IJobHistoryAngulr>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
