...
import { JobHistoryAngulrDeleteDialog } from './job-history-angulr-delete-dialog';

describe('JobHistoryAngulr Management Delete Component', () => {
  let comp: JobHistoryAngulrDeleteDialog;
  let fixture: ComponentFixture<JobHistoryAngulrDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(JobHistoryAngulrDeleteDialog);
