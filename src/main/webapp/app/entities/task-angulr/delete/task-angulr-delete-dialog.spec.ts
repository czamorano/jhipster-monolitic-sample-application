...
import { TaskAngulrDeleteDialog } from './task-angulr-delete-dialog';

describe('TaskAngulr Management Delete Component', () => {
  let comp: TaskAngulrDeleteDialog;
  let fixture: ComponentFixture<TaskAngulrDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TaskAngulrDeleteDialog);
