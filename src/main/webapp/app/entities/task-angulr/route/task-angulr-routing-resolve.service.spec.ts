...
import taskResolve from './task-angulr-routing-resolve.service';

describe('TaskAngulr routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return ITaskAngulr returned by find', async () => {
      // GIVEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      // GIVEN
      vitest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ITaskAngulr>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
