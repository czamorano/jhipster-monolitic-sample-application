...
import { sampleWithRequiredData } from '../task-angulr.test-samples';

import { TaskAngulr } from './task-angulr';

describe('TaskAngulr Management Component', () => {
  let comp: TaskAngulr;
  let fixture: ComponentFixture<TaskAngulr>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TaskAngulr);
  ...
  describe('trackId', () => {
    it('should forward to taskService', () => {
      ...
      vitest.spyOn(service, 'getTaskAngulrIdentifier');
      const id = comp.trackId(entity);
      expect(service.getTaskAngulrIdentifier).toHaveBeenCalledWith(entity);
