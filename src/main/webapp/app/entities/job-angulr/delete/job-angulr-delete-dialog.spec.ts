...
import { JobAngulrDeleteDialog } from './job-angulr-delete-dialog';

describe('JobAngulr Management Delete Component', () => {
  let comp: JobAngulrDeleteDialog;
  let fixture: ComponentFixture<JobAngulrDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(JobAngulrDeleteDialog);
