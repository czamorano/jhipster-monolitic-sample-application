...
import { sampleWithRequiredData } from '../job-angulr.test-samples';
import { JobAngulrService } from '../service/job-angulr.service';

import { JobAngulr } from './job-angulr';

describe('JobAngulr Management Component', () => {
  let comp: JobAngulr;
  let fixture: ComponentFixture<JobAngulr>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(JobAngulr);
  ...
  describe('trackId', () => {
    it('should forward to jobService', () => {
      ...
      vitest.spyOn(service, 'getJobAngulrIdentifier');
      const id = comp.trackId(entity);
      expect(service.getJobAngulrIdentifier).toHaveBeenCalledWith(entity);
