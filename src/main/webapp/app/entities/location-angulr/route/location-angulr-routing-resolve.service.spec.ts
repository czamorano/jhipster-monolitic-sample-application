...
import locationResolve from './location-angulr-routing-resolve.service';

describe('LocationAngulr routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return ILocationAngulr returned by find', async () => {
      // GIVEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      // GIVEN
      vitest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ILocationAngulr>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
