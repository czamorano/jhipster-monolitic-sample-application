...
import { LocationAngulrDeleteDialog } from './location-angulr-delete-dialog';

describe('LocationAngulr Management Delete Component', () => {
  let comp: LocationAngulrDeleteDialog;
  let fixture: ComponentFixture<LocationAngulrDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(LocationAngulrDeleteDialog);
