...
import { sampleWithRequiredData } from '../location-angulr.test-samples';
import { LocationAngulrService } from '../service/location-angulr.service';

import { LocationAngulr } from './location-angulr';

describe('LocationAngulr Management Component', () => {
  let comp: LocationAngulr;
  let fixture: ComponentFixture<LocationAngulr>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(LocationAngulr);
  ...
  describe('trackId', () => {
    it('should forward to locationService', () => {
      ...
      vitest.spyOn(service, 'getLocationAngulrIdentifier');
      const id = comp.trackId(entity);
      expect(service.getLocationAngulrIdentifier).toHaveBeenCalledWith(entity);
