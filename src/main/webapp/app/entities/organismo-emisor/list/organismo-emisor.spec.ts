...
import { sampleWithRequiredData } from '../organismo-emisor.test-samples';
import { OrganismoEmisorService } from '../service/organismo-emisor.service';

import { OrganismoEmisor } from './organismo-emisor';

describe('OrganismoEmisor Management Component', () => {
  let comp: OrganismoEmisor;
  let fixture: ComponentFixture<OrganismoEmisor>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(OrganismoEmisor);
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.organismoEmisors()[0]).toEqual(expect.objectContaining({ id: 10004 }));
  });

  describe('trackId', () => {
    it('should forward to organismoEmisorService', () => {
      const entity = { id: 10004 };
      vitest.spyOn(service, 'getOrganismoEmisorIdentifier');
      const id = comp.trackId(entity);
      expect(service.getOrganismoEmisorIdentifier).toHaveBeenCalledWith(entity);
