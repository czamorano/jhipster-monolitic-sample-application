...
import { OrganismoEmisorDeleteDialog } from './organismo-emisor-delete-dialog';

describe('OrganismoEmisor Management Delete Component', () => {
  let comp: OrganismoEmisorDeleteDialog;
  let fixture: ComponentFixture<OrganismoEmisorDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(OrganismoEmisorDeleteDialog);
