...
import { sampleWithRequiredData } from '../department-angulr.test-samples';
import { DepartmentAngulrService } from '../service/department-angulr.service';

import { DepartmentAngulr } from './department-angulr';

describe('DepartmentAngulr Management Component', () => {
  let comp: DepartmentAngulr;
  let fixture: ComponentFixture<DepartmentAngulr>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DepartmentAngulr);
  ...
  describe('trackId', () => {
    it('should forward to departmentService', () => {
      ...
      vitest.spyOn(service, 'getDepartmentAngulrIdentifier');
      const id = comp.trackId(entity);
      expect(service.getDepartmentAngulrIdentifier).toHaveBeenCalledWith(entity);
