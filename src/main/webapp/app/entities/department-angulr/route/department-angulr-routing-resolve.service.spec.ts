...
import departmentResolve from './department-angulr-routing-resolve.service';

describe('DepartmentAngulr routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IDepartmentAngulr returned by find', async () => {
      // GIVEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      // GIVEN
      vitest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IDepartmentAngulr>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
