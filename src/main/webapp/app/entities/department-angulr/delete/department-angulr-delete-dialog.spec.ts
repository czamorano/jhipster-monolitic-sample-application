...
import { DepartmentAngulrDeleteDialog } from './department-angulr-delete-dialog';

describe('DepartmentAngulr Management Delete Component', () => {
  let comp: DepartmentAngulrDeleteDialog;
  let fixture: ComponentFixture<DepartmentAngulrDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DepartmentAngulrDeleteDialog);
