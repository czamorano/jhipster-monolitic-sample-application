...
import regionResolve from './region-angulr-routing-resolve.service';

describe('RegionAngulr routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IRegionAngulr returned by find', async () => {
      // GIVEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      // GIVEN
      vitest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IRegionAngulr>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
