...
import { sampleWithRequiredData } from '../region-angulr.test-samples';
import { RegionAngulrService } from '../service/region-angulr.service';

import { RegionAngulr } from './region-angulr';

describe('RegionAngulr Management Component', () => {
  let comp: RegionAngulr;
  let fixture: ComponentFixture<RegionAngulr>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(RegionAngulr);
  ...
  describe('trackId', () => {
    it('should forward to regionService', () => {
      ...
      vitest.spyOn(service, 'getRegionAngulrIdentifier');
      const id = comp.trackId(entity);
      expect(service.getRegionAngulrIdentifier).toHaveBeenCalledWith(entity);
