...
import { RegionAngulrDeleteDialog } from './region-angulr-delete-dialog';

describe('RegionAngulr Management Delete Component', () => {
  let comp: RegionAngulrDeleteDialog;
  let fixture: ComponentFixture<RegionAngulrDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(RegionAngulrDeleteDialog);
