...
import { EmployeeAngulrDeleteDialog } from './employee-angulr-delete-dialog';

describe('EmployeeAngulr Management Delete Component', () => {
  let comp: EmployeeAngulrDeleteDialog;
  let fixture: ComponentFixture<EmployeeAngulrDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EmployeeAngulrDeleteDialog);
