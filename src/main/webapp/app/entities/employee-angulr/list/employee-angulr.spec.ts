...
import { sampleWithRequiredData } from '../employee-angulr.test-samples';
import { EmployeeAngulrService } from '../service/employee-angulr.service';

import { EmployeeAngulr } from './employee-angulr';

describe('EmployeeAngulr Management Component', () => {
  let comp: EmployeeAngulr;
  let fixture: ComponentFixture<EmployeeAngulr>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EmployeeAngulr);
  ...
  describe('trackId', () => {
    it('should forward to employeeService', () => {
      ...
      vitest.spyOn(service, 'getEmployeeAngulrIdentifier');
      const id = comp.trackId(entity);
      expect(service.getEmployeeAngulrIdentifier).toHaveBeenCalledWith(entity);
