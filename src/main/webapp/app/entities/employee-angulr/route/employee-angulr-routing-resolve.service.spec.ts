...
import employeeResolve from './employee-angulr-routing-resolve.service';

describe('EmployeeAngulr routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IEmployeeAngulr returned by find', async () => {
      // GIVEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      // GIVEN
      vitest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IEmployeeAngulr>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
