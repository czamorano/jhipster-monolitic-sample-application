...
import { CountryAngulrDeleteDialog } from './country-angulr-delete-dialog';

describe('CountryAngulr Management Delete Component', () => {
  let comp: CountryAngulrDeleteDialog;
  let fixture: ComponentFixture<CountryAngulrDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CountryAngulrDeleteDialog);
