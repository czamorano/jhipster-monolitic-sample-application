...
import { sampleWithRequiredData } from '../country-angulr.test-samples';
import { CountryAngulrService } from '../service/country-angulr.service';

import { CountryAngulr } from './country-angulr';

describe('CountryAngulr Management Component', () => {
  let comp: CountryAngulr;
  let fixture: ComponentFixture<CountryAngulr>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CountryAngulr);
  ...
  describe('trackId', () => {
    it('should forward to countryService', () => {
      ...
      vitest.spyOn(service, 'getCountryAngulrIdentifier');
      const id = comp.trackId(entity);
      expect(service.getCountryAngulrIdentifier).toHaveBeenCalledWith(entity);
