...
import countryResolve from './country-angulr-routing-resolve.service';

describe('CountryAngulr routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return ICountryAngulr returned by find', async () => {
      // GIVEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      // GIVEN
      vitest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ICountryAngulr>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
