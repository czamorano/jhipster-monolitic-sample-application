...
import { sampleWithRequiredData } from '../envio-masivo.test-samples';
import { EnvioMasivoService } from '../service/envio-masivo.service';

import { EnvioMasivo } from './envio-masivo';

describe('EnvioMasivo Management Component', () => {
  let comp: EnvioMasivo;
  let fixture: ComponentFixture<EnvioMasivo>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EnvioMasivo);
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.envioMasivos()[0]).toEqual(expect.objectContaining({ id: 27737 }));
  });

  describe('trackId', () => {
    it('should forward to envioMasivoService', () => {
      const entity = { id: 27737 };
      vitest.spyOn(service, 'getEnvioMasivoIdentifier');
      const id = comp.trackId(entity);
      expect(service.getEnvioMasivoIdentifier).toHaveBeenCalledWith(entity);
