...
import { EnvioMasivoDeleteDialog } from './envio-masivo-delete-dialog';

describe('EnvioMasivo Management Delete Component', () => {
  let comp: EnvioMasivoDeleteDialog;
  let fixture: ComponentFixture<EnvioMasivoDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EnvioMasivoDeleteDialog);
