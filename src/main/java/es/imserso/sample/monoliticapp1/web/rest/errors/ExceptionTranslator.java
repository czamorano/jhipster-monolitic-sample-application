package es.imserso.sample.monoliticapp1.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof es.imserso.sample.monoliticapp1.service.UsernameAlreadyUsedException
        ) return (ProblemDetailWithCause) new LoginAlreadyUsedException().getBody();
        if (
            ex instanceof es.imserso.sample.monoliticapp1.service.EmailAlreadyUsedException
        ) return (ProblemDetailWithCause) new EmailAlreadyUsedException().getBody();
        if (
            ex instanceof es.imserso.sample.monoliticapp1.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return Strings.CS.containsAny(
            ...
            "io.",
            "de.",
            "es.imserso.sample.monoliticapp1"
        );
    }
}
