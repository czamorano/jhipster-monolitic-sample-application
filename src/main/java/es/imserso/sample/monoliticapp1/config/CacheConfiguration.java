...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, es.imserso.sample.monoliticapp1.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, es.imserso.sample.monoliticapp1.repository.UserRepository.USERS_BY_EMAIL_CACHE);
